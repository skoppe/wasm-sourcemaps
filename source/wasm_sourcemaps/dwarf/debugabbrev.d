...
enum AttributeForm : ULEB128 {
	addr = 0x01, // size is defined in compile_unit
  block2 = 0x03, // 2 byte length with payload
    block4 = 0x04, // 4 byte length with payload
    data2 = 0x05, // 2 bytes
    data4 = 0x06, // 4 bytes
    data8 = 0x07, // 8 bytes
    string_ = 0x08, // null terminated string
    block = 0x09, // a uleb128 length with payload
    block1 = 0x0a, // 1 byte length with payload
    data1 = 0x0b, // 1 byte
    flag = 0x0c, // 1 byte
    sdata = 0x0d, // sleb128
    strp = 0x0e, // 4 byte reference to debug_str
    udata = 0x0f, // uleb128
    refAddr = 0x10, // 4 bytes in 32-bit dwarf, 8 bytes in 64 bit dwarf
    ref1 = 0x11, // 1 byte ref
    ref2 = 0x12, // 2 byte ref
    ref4 = 0x13, // 4 byte ref
    ref8 = 0x14, // 8 byte ref
    refUdata = 0x15, // uleb128 ref
    indirect = 0x16, // uleb128 encoding of the form
    secOffset = 0x17, // 4 bytes in 32-bit dwarf, 8 bytes in 64 bit dwarf
    exprLoc =  0x18, // uleb128 length with payload
    flagPresent = 0x19, // no data but flag is always set
    refSig8 = 0x20 // uleb128 ref
}
